  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome back to TaxLitigationOnline.",
      });
        ...
        <Card>
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="text-brand-blue hover:text-brand-lightblue">
                    Forgot password?
                  </Link>
                </div>
              </div>
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="font-medium text-brand-blue hover:text-brand-lightblue">
                Sign up
              </Link>
            </p>
          </CardFooter>
